...
const ProjectCard = ({
    ...
    return (
        <motion.div
            className={`relative bg-cover bg-no-repeat bg-center z-10 h-[550px] w-full items-stretch justify-center py-0 sm:h-[700px] sm:w-full md:h-[650px] md:w-full lg:h-[500px]`}
            initial="initial"
            animate="animate"
        >
            <Container
